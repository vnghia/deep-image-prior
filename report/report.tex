...
{\centering \subfloat[original\label{fig:noisy-original-image-1}]{\includegraphics[width=0.25\linewidth]{../res/denoising/input} }\subfloat[bruité\label{fig:noisy-original-image-2}]{\includegraphics[width=0.25\linewidth]{../res/denoising/noisy} }
